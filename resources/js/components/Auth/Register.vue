        ...
        <div class="login-box">
            ...
            <div class="login-form">
                <el-form label-position="top" :model="loginForm" ref="registerForm">
                    ...
                    <el-form-item :rules="$store.state.validate.required" prop="password_confirmation">
                        <el-input placeholder="Enter Password" type="password" v-model="loginForm.password_confirmation"
                                  auto-complete="off"></el-input>
                        </el-form-item>
                    <el-form-item>
                        <el-button type="primary" :disabled="loading" :loading="loading" @click="handleSubmit">Register</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
