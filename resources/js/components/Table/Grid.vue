    ...
    <div>
        ...
        <el-table :data="data.data"
            ...
            <el-table-column
                ...
                <template v-if="can[canUpdate] || can[canDelete] " slot-scope="scope">
                    <el-button
                        v-if="showEdit || can[canUpdate] ? can[canUpdate] : false  "
                        size="mini"
                        @click="handleEdit(scope.$index, scope.row)">Edit
                        </el-button>
                    <el-button
                        v-if="showDelete || can[canDelete] ? can[canDelete] : false"
                        size="mini"
                        type="danger"
